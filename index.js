...
function cuter(gotid){
    console.log(document.getElementById(gotid).value)
    if(document.getElementById(gotid).value!=" "){
        document.getElementById(gotid).style.textDecoration="line-through";
        document.getElementById(gotid).style.color="red";
        jaldi+=1
    }
    
    if(gotid[3]==0 && document.getElementById(gotid).value!=" "){
        frow+=1
    }
    else if(gotid[3]==1 && document.getElementById(gotid).value!=" "){
        srow+=1
    }
    else if(gotid[3]==2 && document.getElementById(gotid).value!=" "){
        trow+=1
    }
    if(jaldi==5 && document.getElementById(gotid).value!=" "){
